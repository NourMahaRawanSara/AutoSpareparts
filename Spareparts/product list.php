			...
			<ul class="nav navbar-nav" id="navbarontop">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dropdowncostume">
						<li><a href="sales list.php">Sales list</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dropdowncostume">
						<li><a href="product list.php">price list</a></li>
						<li><a href="order.php">spare orders</a></li>
...
<?php
						...
						$select_sql = "SELECT ID,product_name,product_code,price FROM product";
						$result = mysqli_query($conn, $select_sql);
						for ($i=0; $i < $result->num_rows; $i++) { 
							$row = $result->fetch_assoc();
							echo "Id: " . $row["ID"]. " - Name: " . $row["Product_name"]. " code:" . $row["product_code"]. . $row["price"]. "<br>";
						}
